...
this.curstep += 1;
        result = { a: this.currlien, b: this.currMsg, c: this.links, d: this.msgs, e: this.newmsg, f: this.chosen, g: this.mada, h: this.add, j: this.download, k: this.student, l: this.content, m: step};
      console.log(result);
         saveDataToDB(result);
        return result;
    }
