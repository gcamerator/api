...
class Moutamadris {
    ...
    async Choice(choice, step, data) {
        ...
        saveDataToDB(result, this.user);
        let res = {msg: result.currMsg, step: result.currstep, choose: result.chosen, lien: result.currlien, download: result.download, max: result.max}
