    ...
    try {
      ...
      truecallerjs.search(searchData)
        .then(response => {
          ...
          const nationalFormat = response.getNationalFormat();
          const countryCode = response.getCountryDetails().isoCode;
          const carrier = response.getCarriers().primary;
          const numberType = response.getNumberType();
