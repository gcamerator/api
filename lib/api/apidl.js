...
function salat() {
  return new Promise((resolve, reject) => {
    const result = '[{"Fajr":"الأيام","Sunrise":"شعبان","Dhuhr":"فبراير / مارس","Asr":"الصبح","Maghrib":"الشروق","Isha":"الظهر"},{"Fajr":"الإثنين","Sunrise":"حسب نتيجة المراقبة","Dhuhr":"11","Asr":"06:14","Maghrib":"07:40","Isha":"13:42"}]';
    // قم بحل الوعد بإرسال النتيجة
    resolve(result);
  });
}
