...
//―――――――――――――――――――――――――――――――――――――――――― ┏  ApiDl By Alip ┓ ―――――――――――――――――――――――――――――――――――――――――― \\
async function markoub(city1, city2, seats, date) {
  try {
    const url = `https://www.markoub.ma/fr/Recherche/Show?villeDepartId=${city1}&villeArriveeId=${city2}&nbrSeat=${seats}&dateDepart=2024-02-${date}`;
    ...
    const final = match[1]
      .replace(/\s+/g, "")
      .replace(/false(?={"voyageId)/g, "false},")
      .replace(/true(?={"voyageId)/g, "true},");

    const resul = `[${final}]`;
    const data = JSON.parse(resul);

    const cleaned = data.map(item => {
      const { voyageId, equipements, societeId, societeCode, societeNom, ...rest } = item;
      return { ...rest };
    });
